      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div ref={titleRef} className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            <span className="gradient-text">Future-Grade</span> Features
          </h2>
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            SimulEx combines cutting-edge technology with immersive game design to create a truly unique training experience.
          </p>
        </div>
        ...
        {/* Decorative elements */}
        <div className="absolute top-1/4 right-0 w-64 h-64 bg-purple-500/10 rounded-full blur-3xl -z-10"></div>
        <div className="absolute bottom-1/4 left-0 w-64 h-64 bg-cyan-500/10 rounded-full blur-3xl -z-10"></div>
      </div>
    </section>
  );
}
